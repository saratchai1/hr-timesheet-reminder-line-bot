-- ============================================================================
-- Supabase setup for HR Timesheet Reminder LINE Bot
-- ============================================================================
-- Beginner-friendly one-file setup.
...
DROP TRIGGER IF EXISTS update_timesheet_status_updated_at ON timesheet_status;
CREATE TRIGGER update_timesheet_status_updated_at
BEFORE UPDATE ON timesheet_status
FOR EACH ROW
EXECUTE FUNCTION update_updated_at_column();

-- Allow the Netlify app to use Supabase Data API with the anon/publishable key.
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE employees TO anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE timesheet_status TO anon, authenticated;
GRANT SELECT, INSERT ON TABLE notification_logs TO anon, authenticated;
